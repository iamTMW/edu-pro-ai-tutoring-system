...
if __name__ == "__main__":
    ...
    # Class template (module -> lesson -> questions)
    template = {
        "lesson_001": [
            {
                "id": "q1",
                ...
                "solution": 2,
                "hints": ["Think about adding small numbers first", "Double-check your calculation"],
                "solution_feedback": "The answer is 2 because 1 + 1 = 2"
            },
            {
                "id": "q2",
                "level": "easy",
                ...
                "solution": 5,
                "hints": ["Consider multiplication", "Break the problem into parts"],
                "solution_feedback": "The answer is 5 because 2 + 3 = 5"
            }
        ],
        "lesson_002": [
            {
                ...
                "solution": 144,
                "hints": ["Think about squares", "12 * 12 might help"],
                "solution_feedback": "The answer is 144 because 12 squared is 144"
            }
        ],
        "lesson_003": [
            {
                ...
                "solution": 10,
                "hints": ["Add all numbers", "Check your arithmetic"],
                "solution_feedback": "The answer is 10 by summing 4 + 6"
            }
        ]
    }

    html_lessons = {
        "lesson_001": "<html><body>Lesson 1 content</body></html>",
        "lesson_002": "<html><body>Lesson 2 content</body></html>",
        "lesson_003": "<html><body>Lesson 3 content</body></html>"
    }
    ...
    for name in student_names:
        signup(name, "pw")
        login_data = login(name, "pw")
        student_userid = login_data.get("userid")
        student_ids.append(student_userid)
        join_class(student_userid, class_id)

        # Fetch progress
        progress_data = get_progress(student_userid, class_id)
        modules = progress_data.get("progress", {}).get("modules", {})

        # Walk through modules dynamically
        # Walk through lessons directly
        ...
        for lesson_id, lesson in lessons.items():
            ...
            # Answer questions (MMR threshold logic handled on frontend)
            ...
            # Now explicitly complete the lesson
            complete_lesson(student_userid, class_id, lesson_id)

        # Final progress after all modules
